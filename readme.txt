...
= Demo =
See it in action on the [Pencil2D page](http://www.pencil2d.org/pencil2d).

= Contributors =
[Contributors are listed
here](https://github.com/gordielachance/wp-bitbucket/contributors)
= Notes =

For feature request and bug reports, [please use the
forums](http://wordpress.org/support/plugin/wp-bitbucket#postform).

If you are a plugin developer, [we would like to hear from
you](https://github.com/gordielachance/wp-bitbucket). Any contribution would be
very welcome.
